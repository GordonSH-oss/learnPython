...
| 4 | [测量并优化](chapters/04-performance.md) | 怎样证明加速正确、稳定且值得维护？ | `benchmark.py`、`test_using_c.py` |
| 5 | [Cython 与生产化](chapters/05-cython-and-production.md) | 如何渐进类型化并交付跨平台扩展？ | `cython_example.pyx`、`setup_cython.py` |
